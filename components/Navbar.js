...
const Navbar = () => {
    return (
        <nav className="top-0 sm:px-4 py-2.5 w-full z-50">
            <div className="h-16 mx-10 flex text-diff-gray relative justify-center sm:justify-around items-center whitespace-nowrap">
                <a href="https://csivit.com" target="_blank">
                    <Image src="/images/Logo.png" height="30" width="160" alt="CSI_logo" />
                </a>
                <div className="hidden md:flex text-2xl font-medium content-center items-center">
