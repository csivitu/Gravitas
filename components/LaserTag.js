...
function LaserTag() {
    return (
        <div id="LaserTag" className="flex min-h-screen justify-center items-center px-6 md:px-40">
            <div className="flex flex-col gap-10">
                ...
                <div className="flex items-center gap-20 mb-10">
                    <div className="flex flex-col md:flex-row items-center gap-20 mb-10">
                        <Lottie animationData={laserTagAnimation} style={{ width: "50%" }} />
                        <div className='w-1/2 flex flex-col items-start md:text-xl'>
