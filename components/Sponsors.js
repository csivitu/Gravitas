...
const Sponsors = () => {
    return (
        <div id="Sponsors" className="z-40" layers={[{ image: '/assets/starbg.png', speed: 30 }]} >
            <section className="w-full justify-evenly items-center text-center flex flex-col p-4 sm:p-10 " style={{ backgroundColor: "#16191B" }} >
                ...
                <div className="mt-10">
                    ...
                    <a href="https://www.experionglobal.com/" target="_blank" rel="noreferrer" className="relative flex justify-center items-center p-3 sm:p-5 z-50">
                        <img src="/assets/sponsor_logos/experion.png" className="w-1/2 sm:w-full h-auto" />
                    </a>
                </div>
                <div className="flex flex-col w-screen justify-center items-center mt-10" id="diamond">
                    ...
                    <div className="w-full grid grid-cols-3 content-center  place-items-center gap-2 mt-2 p-3 sm:p-5">
                        <a href="https://witnet.io/" target="_blank" rel="noreferrer" className="z-50 w-2/4">
                            <img src='/assets/sponsor_logos/wilnet.png' className=" h-auto" />
                        </a>
                        <a href="https://oceanprotocol.com/" target="_blank" rel="noreferrer" className="z-50 w-2/4 h-auto" >
                            <img src='/assets/sponsor_logos/op.png' />
                        </a>
                        <a href="https://synthetix.io/" target="_blank" rel="noreferrer" className="z-50 w-2/4 h-auto">
                            <img src="/assets/sponsor_logos/SNX.svg" className="z-50" />
                        </a>
                    </div>
                </div>
